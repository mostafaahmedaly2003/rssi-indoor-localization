...
| File | Description |
|------|-------------|
| `outputs/confusion_matrices.png` | Per-class prediction accuracy for all 3 models |
| `outputs/floor_map.png` | Visual floor plan with predicted vs actual positions |
| `outputs/model_comparison.png` | Bar charts comparing accuracy and distance error |
